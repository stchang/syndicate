...
var _cachedAssertion1470598812190_0 = (function() { var _ = Syndicate.__; return fromBroker(this.wsurl, locationRecord(id, email, _, _, _)); }).call(this);
Syndicate.Actor.createFacet()
...
.onEvent(Syndicate.Actor.PRIORITY_NORMAL, true, "retracted", (function() { var _ = Syndicate.__; return Syndicate.Patch.sub(_cachedAssertion1470598812190_0, 0); }), (function() { var _ = Syndicate.__; return { assertion: _cachedAssertion1470598812190_0, metalevel: 0 }; }), (function() {})).completeBuild(); })).completeBuild(); }).call(this);
  });
}).startStepping();
